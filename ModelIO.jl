...
type ModelIO
  ...
  function ModelIO(prior::PriorDistribution, obsnodes::Array{ObservationNode,1}, hmminitprobs::Array{Float64,1}, hmmtransprobs::Array{Float64,2})
      return new(prior, obsnodes, hmminitprobs, hmmtransprobs, length(hmminitprobs))
  end
end

function write_hiddenstates(modelio::ModelIO, filename)
  out = open(filename, "w")
