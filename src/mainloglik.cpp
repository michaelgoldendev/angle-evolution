...
// Declaration
double LogLikMWNOUPairs(arma::mat x, double t, arma::vec mu, arma::vec alpha, arma::vec sigma, int maxK, double etrunc);
...
int main(int argc, char** argv) {
  ...
  // Call function
  double result = LogLikMWNOUPairs(x, t, mu, alpha, sigma, maxK, etrunc);
